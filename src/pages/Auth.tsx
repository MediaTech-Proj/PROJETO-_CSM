    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center gap-2 mb-8">
          <div className="bg-gradient-to-r from-primary to-secondary p-3 rounded-lg shadow-glow-primary">
            <Film className="w-8 h-8 text-white" />
          </div>
          <div className="text-center">
            <h1 className="text-2xl font-bold bg-gradient-to-r from-primary-glow to-secondary-glow bg-clip-text text-transparent">
              MediaTech Store
            </h1>
            <p className="text-sm text-muted-foreground">Sua plataforma de streaming</p>
          </div>
        </div>

        <Card className="bg-card/80 backdrop-blur border-border/50 shadow-elevated">
